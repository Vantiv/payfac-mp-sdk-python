...
def test_get_retrieval_request():
        ...
        # payfac_agreement.post_by_legalEntityId("201003", agreementPostRequest)

        # payfac_agreement.get_by_legalEntityId("1000293")
        ...
        # payfac_legalEntity.post_by_legalEntity(legalEntityPostRequest)
        ...
        # payfac_legalEntity.put_by_legalEntityId("1000293",legalEntityPutRequest)
        ...
        # payfac_principal.post_by_legalEntity("2018",principalPostRequest)
