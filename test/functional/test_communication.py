...
class TestCommunication(unittest.TestCase):
    ...
    def test_http_get_retrieval_request(self):
        response = communication.http_get_retrieval_request("/legalentity/1000293","legalEntityRetrievalResponse")
    ...
    def test_http_get_retrieval_request_with_PayfacError(self):
        ...
        self.assertRaises(utils.PayfacError, communication.http_get_retrieval_request, "/legalentity/1000293", "legalEntityRetrievalResponse",new_conf)
    ...
    def test_http_post_request(self):
        ...
        response = communication.http_post_request("/legalentity/21003/agreement",agreementPostRequest,"legalEntityAgreementCreateResponse")
        self.assertIsNotNone(response["transactionId"])
    ...
    def test_http_post_request_with_PayfacError(self):
        ...
        new_conf = utils.Configuration()
        new_conf.__setattr__("url","https://")
        self.assertRaises(utils.PayfacError, communication.http_post_request, "/legalentity/21003/agreement", agreementPostRequest,"legalEntityRetrievalResponse",new_conf)
    ...
    def test_http_put_request(self):
        ...
        response = communication.http_put_request("/legalentity/1000293",legalEntityPutRequest,"legalEntityResponse")
        self.assertIsNotNone(response["transactionId"])
        self.assertEquals("1000293",response["legalEntityId"])
    ...
    def test_http_put_request_with_PayfacError(self):
        ...
        new_conf = utils.Configuration()
        new_conf.__setattr__("url","https://")
        self.assertRaises(utils.PayfacError, communication.http_put_request, "/legalentity/1000293", legalEntityPutRequest,"legalEntityResponse",new_conf)

    def test_http_delete_request(self):
        response = communication.http_delete_request("/legalentity/2018/principal/9","principalDeleteResponse")
        self.assertIsNotNone(response["transactionId"])
    ...
    def test_http_delete_request_with_PayfacError(self):
        new_conf = utils.Configuration()
        new_conf.__setattr__("url", "https://")
        self.assertRaises(utils.PayfacError, communication.http_delete_request, "/legalentity/2018/principal/9", "principalDeleteResponse", new_conf)
